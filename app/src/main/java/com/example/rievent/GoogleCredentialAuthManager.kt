package com.example.rievent.auth
...
class GoogleCredentialAuthManager(private val context: Context) {

    private val credentialManager = CredentialManager.create(context)

    suspend fun requestGoogleIdToken(): String? = withContext(Dispatchers.IO) {
        try {
